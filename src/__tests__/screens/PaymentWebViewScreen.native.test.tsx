...
// Import explícito por archivo (no el specifier "pelado") -- esto es
// justamente lo que se está probando: que la variante NATIVA es la que usa
// WebView de verdad, sin depender de qué plataforma haya elegido el resolver
// de Jest para un import sin sufijo.
import PaymentWebViewScreen from '../../screens/PaymentWebViewScreen.native';
...
describe('PaymentWebViewScreen.native -- checkout con WebView embebido', () => {
